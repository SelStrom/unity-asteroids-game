...
namespace SelStrom.Asteroids
{
    public class PlayerInput
    {
        ...
        public event Action OnMissileAction;
        ...
        public PlayerInput()
        {
            ...
            _playerControls.Missile.performed += OnMissile;
        ...
        [PublicAPI]
        private void OnMissile(InputAction.CallbackContext _)
        {
            OnMissileAction?.Invoke();
        }
